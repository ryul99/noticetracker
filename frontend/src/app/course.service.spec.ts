...
describe('CourseService', () => {
  ...
  it('searchByCode', () => {
    ...
    const req = httpMock.expectOne('search/id/M1522');
  ...
  it('searchByName', () => {
    ...
    const req = httpMock.expectOne('search/name/프로그래밍');
    expect(req.request.method).toBe('GET');
  ...
  it('getCourseObjectById', () => {
    ...
    const req = httpMock.expectOne('course/5');
    expect(req.request.method).toBe('GET');
  ...
  it('getRecommendedSitesById', () => {
    ...
    const req = httpMock.expectOne('course/3/site');
    expect(req.request.method).toBe('GET');
